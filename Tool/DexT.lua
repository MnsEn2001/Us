...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'เชิญเข้าร่วมเซิร์ฟเวอร์สนับสนุน Infinite Yield'}
CMDs[#CMDs + 1] = {NAME = 'guiscale [number]', DESC = 'เปลี่ยนขนาดของ GUI [number] ยอมรับทั้งทศนิยมและจำนวนเต็ม ขั้นต่ำคือ 0.4 และสูงสุดคือ 2'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = 'โหลดคอนโซล Roblox'}
CMDs[#CMDs + 1] = {NAME = 'oldconsole', DESC = 'โหลดคอนโซล Roblox รุ่นเก่า'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'เปิด DEX โดย Moon'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'เปิด DEX รุ่นเก่าโดย Moon'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = 'เปิด Simple Spy V3'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = 'เปิดเครื่องบันทึกเสียงของ Edge'}
CMDs[#CMDs + 1] = {NAME = 'serverinfo / info', DESC = 'ให้ข้อมูลเกี่ยวกับเซิร์ฟเวอร์'}
CMDs[#CMDs + 1] = {NAME = 'jobid', DESC = 'คัดลอก JobId ของเกมไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'notifyjobid', DESC = 'แจ้งเตือน JobId ของเกม'}
CMDs[#CMDs + 1] = {NAME = 'rejoin / rj', DESC = 'ทำให้คุณกลับเข้ามาในเกมใหม่'}
CMDs[#CMDs + 1] = {NAME = 'autorejoin / autorj', DESC = 'เข้าร่วมเซิร์ฟเวอร์ใหม่โดยอัตโนมัติหากถูกเตะหรือตัดการเชื่อมต่อ'}
CMDs[#CMDs + 1] = {NAME = 'serverhop / shop', DESC = 'ย้ายคุณไปยังเซิร์ฟเวอร์อื่น'}
CMDs[#CMDs + 1] = {NAME = 'gameteleport / gametp [place ID]', DESC = 'เข้าร่วมเกมโดยใช้ ID'}
CMDs[#CMDs + 1] = {NAME = 'antiidle / antiafk', DESC = 'ป้องกันเกมเตะคุณออกจากการไม่ได้ใช้งาน'}
CMDs[#CMDs + 1] = {NAME = 'datalimit [num]', DESC = 'ตั้งค่าขีดจำกัด KBPS ขาออก'}
CMDs[#CMDs + 1] = {NAME = 'replicationlag / backtrack [num]', DESC = 'ตั้งค่า IncomingReplicationLag'}
CMDs[#CMDs + 1] = {NAME = 'creatorid / creator', DESC = 'แจ้งเตือน ID ของผู้สร้าง'}
CMDs[#CMDs + 1] = {NAME = 'copycreatorid / copycreator', DESC = 'คัดลอก ID ของผู้สร้างไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'setcreatorid / setcreator', DESC = 'ตั้งค่า ID ผู้ใช้ของคุณเป็น ID ของผู้สร้าง'}
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = 'ป้องกันเกมแสดงข้อความแจ้งการซื้อหรือพรีเมียม'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = 'อนุญาตให้เกมแสดงข้อความแจ้งการซื้อหรือพรีเมียมอีกครั้ง'}
CMDs[#CMDs + 1] = {NAME = 'enable [inventory/playerlist/chat/reset/emotes/all]', DESC = 'สลับการมองเห็นของรายการ CoreGUI'}
CMDs[#CMDs + 1] = {NAME = 'disable [inventory/playerlist/chat/reset/emotes/all]', DESC = 'สลับการมองเห็นของรายการ CoreGUI'}
CMDs[#CMDs + 1] = {NAME = 'showguis', DESC = 'แสดง GUI ที่มองไม่เห็น'}
CMDs[#CMDs + 1] = {NAME = 'unshowguis', DESC = 'ยกเลิกการแสดง GUI'}
CMDs[#CMDs + 1] = {NAME = 'hideguis', DESC = 'ซ่อน GUI ใน PlayerGui'}
CMDs[#CMDs + 1] = {NAME = 'unhideguis', DESC = 'ยกเลิกการซ่อน GUI'}
CMDs[#CMDs + 1] = {NAME = 'guidelete', DESC = 'เปิดใช้งานปุ่ม Backspace เพื่อลบ GUI'}
CMDs[#CMDs + 1] = {NAME = 'unguidelete / noguidelete', DESC = 'ปิดใช้งานการลบ GUI'}
CMDs[#CMDs + 1] = {NAME = 'hideiy', DESC = 'ซ่อน GUI หลักของ IY'}
CMDs[#CMDs + 1] = {NAME = 'showiy / unhideiy', DESC = 'แสดง GUI ของ IY อีกครั้ง'}
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = 'รัน IY อัตโนมัติเมื่อคุณย้ายผ่านเซิร์ฟเวอร์'}
CMDs[#CMDs + 1] = {NAME = 'unkeepiy', DESC = 'ปิดใช้งาน keepiy'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepiy', DESC = 'สลับการใช้งาน keepiy'}
CMDs[#CMDs + 1] = {NAME = 'savegame / saveplace', DESC = 'ใช้ saveinstance เพื่อบันทึกเกม'}
CMDs[#CMDs + 1] = {NAME = 'clearerror', DESC = 'ล้างกล่องข้อความและภาพเบลอที่น่ารำคาญเมื่อเกมเตะคุณ'}
CMDs[#CMDs + 1] = {NAME = 'clientantikick / antikick (CLIENT)', DESC = 'ป้องกันสคริปต์ในเครื่องเตะคุณ'}
CMDs[#CMDs + 1] = {NAME = 'clientantiteleport / antiteleport (CLIENT)', DESC = 'ป้องกันสคริปต์ในเครื่องย้ายคุณ'}
CMDs[#CMDs + 1] = {NAME = 'allowrejoin / allowrj [true/false] (CLIENT)', DESC = 'เปลี่ยนว่าการป้องกันการย้ายจะอนุญาตให้คุณกลับเข้าเกมได้หรือไม่'}
CMDs[#CMDs + 1] = {NAME = 'cancelteleport / canceltp', DESC = 'ยกเลิกการย้ายที่กำลังดำเนินการ'}
CMDs[#CMDs + 1] = {NAME = 'volume / vol [0-10]', DESC = 'ปรับระดับเสียงของเกมในช่วง 0 ถึง 10'}
CMDs[#CMDs + 1] = {NAME = 'antilag / boostfps / lowgraphics', DESC = 'ลดคุณภาพของเกมเพื่อเพิ่ม FPS'}
CMDs[#CMDs + 1] = {NAME = 'record / rec', DESC = 'เริ่มการบันทึกของ Roblox'}
CMDs[#CMDs + 1] = {NAME = 'screenshot / scrnshot', DESC = 'ถ่ายภาพหน้าจอ'}
CMDs[#CMDs + 1] = {NAME = 'togglefullscreen / togglefs', DESC = 'สลับโหมดเต็มหน้าจอ'}
CMDs[#CMDs + 1] = {NAME = 'notify [text]', DESC = 'ส่งการแจ้งเตือนด้วยข้อความที่ระบุ'}
CMDs[#CMDs + 1] = {NAME = 'lastcommand / lastcmd', DESC = 'รันคำสั่งก่อนหน้าที่ใช้'}
CMDs[#CMDs + 1] = {NAME = 'exit', DESC = 'ปิดกระบวนการ Roblox'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'noclip', DESC = 'ผ่านวัตถุได้'}
CMDs[#CMDs + 1] = {NAME = 'unnoclip / clip', DESC = 'ปิดใช้งาน noclip'}
CMDs[#CMDs + 1] = {NAME = 'fly [speed]', DESC = 'ทำให้คุณบินได้'}
CMDs[#CMDs + 1] = {NAME = 'unfly', DESC = 'ปิดใช้งานการบิน'}
CMDs[#CMDs + 1] = {NAME = 'flyspeed [num]', DESC = 'ตั้งค่าความเร็วการบิน (ค่าเริ่มต้นคือ 20)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclefly / vfly [speed]', DESC = 'ทำให้คุณบินในยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'unvehiclefly / unvfly', DESC = 'ปิดใช้งานการบินในยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'vehicleflyspeed  / vflyspeed [num]', DESC = 'ตั้งค่าความเร็วการบินในยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'cframefly / cfly [speed]', DESC = 'ทำให้คุณบินได้ โดยเลี่ยงการป้องกันบางอย่าง (ใช้งานได้บนมือถือ)'}
CMDs[#CMDs + 1] = {NAME = 'uncframefly / uncfly', DESC = 'ปิดใช้งาน cfly'}
CMDs[#CMDs + 1] = {NAME = 'cframeflyspeed  / cflyspeed [num]', DESC = 'ตั้งค่าความเร็วของ cfly'}
CMDs[#CMDs + 1] = {NAME = 'qefly [true / false]', DESC = 'เปิดหรือปิดปุ่ม Q และ E สำหรับการบิน'}
CMDs[#CMDs + 1] = {NAME = 'vehiclenoclip / vnoclip', DESC = 'ปิดการชนของยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'vehicleclip / vclip / unvnoclip', DESC = 'เปิดใช้งานการชนของยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'float /  platform', DESC = 'สร้างแพลตฟอร์มใต้ตัวคุณเพื่อให้ลอยได้'}
CMDs[#CMDs + 1] = {NAME = 'unfloat / noplatform', DESC = 'ลบแพลตฟอร์มออก'}
CMDs[#CMDs + 1] = {NAME = 'swim', DESC = 'ให้คุณว่ายน้ำในอากาศ'}
CMDs[#CMDs + 1] = {NAME = 'unswim / noswim', DESC = 'หยุดการว่ายน้ำในทุกที่'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / swp [name]', DESC = 'ตั้งจุดหมายที่ตำแหน่งของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'waypointpos / wpp [name] [X Y Z]', DESC = 'ตั้งจุดหมายด้วยพิกัดที่ระบุ'}
CMDs[#CMDs + 1] = {NAME = 'waypoints', DESC = 'แสดงรายการจุดหมายที่ใช้งานอยู่'}
CMDs[#CMDs + 1] = {NAME = 'showwaypoints / showwp', DESC = 'แสดงจุดหมายทั้งหมดที่ตั้งไว้'}
CMDs[#CMDs + 1] = {NAME = 'hidewaypoints / hidewp', DESC = 'ซ่อนจุดหมายที่แสดง'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / wp [name]', DESC = 'ย้ายผู้เล่นไปยังจุดหมาย'}
CMDs[#CMDs + 1] = {NAME = 'tweenwaypoint / twp [name]', DESC = 'เคลื่อนย้ายผู้เล่นไปยังจุดหมายแบบนุ่มนวล'}
CMDs[#CMDs + 1] = {NAME = 'walktowaypoint / wtwp [name]', DESC = 'เดินไปยังจุดหมาย'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dwp [name]', DESC = 'ลบจุดหมาย'}
CMDs[#CMDs + 1] = {NAME = 'clearwaypoints / cwp', DESC = 'ล้างจุดหมายทั้งหมด'}
CMDs[#CMDs + 1] = {NAME = 'cleargamewaypoints / cgamewp', DESC = 'ล้างจุดหมายทั้งหมดในเกมที่คุณอยู่'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'goto [player]', DESC = 'ไปหาผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'tweengoto / tgoto [player]', DESC = 'เคลื่อนไปหาผู้เล่นแบบนุ่มนวล (เลี่ยงการป้องกันบางอย่าง)'}
CMDs[#CMDs + 1] = {NAME = 'tweenspeed / tspeed [num]', DESC = 'ตั้งค่าความเร็วของคำสั่ง tween ทั้งหมด (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclegoto / vgoto [player]', DESC = 'ไปหาผู้เล่นขณะอยู่ในยานพาหนะ'}
CMDs[#CMDs + 1] = {NAME = 'loopgoto [player] [distance] [delay]', DESC = 'ย้ายไปหาผู้เล่นแบบวนซ้ำ'}
CMDs[#CMDs + 1] = {NAME = 'unloopgoto', DESC = 'หยุดการย้ายไปหาผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'pulsetp / ptp [player] [seconds]', DESC = 'ย้ายคุณไปหาผู้เล่นเป็นระยะเวลาที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'clientbring / cbring [player] (CLIENT)', DESC = 'นำผู้เล่นมาหาคุณ'}
CMDs[#CMDs + 1] = {NAME = 'loopbring [player] [distance] [delay] (CLIENT)', DESC = 'นำผู้เล่นมาหาคุณแบบวนซ้ำ (มีประโยชน์สำหรับการฆ่า)'}
CMDs[#CMDs + 1] = {NAME = 'unloopbring [player]', DESC = 'ยกเลิก loopbring'}
CMDs[#CMDs + 1] = {NAME = 'freeze / fr [player] (CLIENT)', DESC = 'แช่แข็งผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'freezeanims', DESC = 'แช่แข็งแอนิเมชันของคุณ / หยุดแอนิเมชันชั่วคราว - ไม่ทำงานกับแอนิเมชันเริ่มต้น'}
CMDs[#CMDs + 1] = {NAME = 'unfreezeanims', DESC = 'ปลดแช่แข็งแอนิเมชัน / เล่นแอนิเมชันต่อ'}
CMDs[#CMDs + 1] = {NAME = 'thaw / unfr [player] (CLIENT)', DESC = 'ปลดแช่แข็งผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'tpposition / tppos [X Y Z]', DESC = 'ย้ายคุณไปยังพิกัดที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'tweentpposition / ttppos [X Y Z]', DESC = 'เคลื่อนไปยังพิกัดแบบนุ่มนวล (เลี่ยงการป้องกันบางอย่าง)'}
CMDs[#CMDs + 1] = {NAME = 'offset [X Y Z]', DESC = 'เลื่อนคุณตามพิกัดที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'tweenoffset / toffset [X Y Z]', DESC = 'เลื่อนแบบนุ่มนวล (เลี่ยงการป้องกันบางอย่าง)'}
CMDs[#CMDs + 1] = {NAME = 'notifyposition / notifypos [player]', DESC = 'แจ้งเตือนพิกัดของตัวละคร'}
CMDs[#CMDs + 1] = {NAME = 'copyposition / copypos [player]', DESC = 'คัดลอกพิกัดของตัวละครไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'walktoposition / walktopos [X Y Z]', DESC = 'ทำให้คุณเดินไปยังพิกัด'}
CMDs[#CMDs + 1] = {NAME = 'spawnpoint / spawn [delay]', DESC = 'ตั้งตำแหน่งที่คุณจะเกิดใหม่'}
CMDs[#CMDs + 1] = {NAME = 'nospawnpoint / nospawn', DESC = 'ลบจุดเกิดที่กำหนดเอง'}
CMDs[#CMDs + 1] = {NAME = 'flashback / diedtp', DESC = 'ย้ายคุณไปยังจุดที่คุณตายล่าสุด'}
CMDs[#CMDs + 1] = {NAME = 'walltp', DESC = 'ย้ายคุณไปด้านบนหรือข้ามกำแพงที่คุณวิ่งชน'}
CMDs[#CMDs + 1] = {NAME = 'nowalltp / unwalltp', DESC = 'ปิดใช้งาน walltp'}
CMDs[#CMDs + 1] = {NAME = 'teleporttool / tptool', DESC = 'ให้เครื่องมือเทเลพอร์ตแก่คุณ'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'logs', DESC = 'เปิด GUI บันทึก'}
CMDs[#CMDs + 1] = {NAME = 'chatlogs / clogs', DESC = 'บันทึกสิ่งที่ผู้คนพูดหรือกระซิบ'}
CMDs[#CMDs + 1] = {NAME = 'joinlogs / jlogs', DESC = 'บันทึกเมื่อมีคนเข้าร่วม'}
CMDs[#CMDs + 1] = {NAME = 'chatlogswebhook / logswebhook [url]', DESC = 'ตั้งค่า Discord webhook สำหรับบันทึกแชท (ไม่ระบุ URL เพื่อปิดใช้งาน)'}
CMDs[#CMDs + 1] = {NAME = 'antichatlogs / antichatlogger', DESC = 'ป้องกัน Roblox แบนคุณจากข้อความแชทโง่ๆ (เกมต้องใช้แชทแบบเก่า)'}
CMDs[#CMDs + 1] = {NAME = 'chat / say [text]', DESC = 'ทำให้คุณแชทข้อความ (อาจเลี่ยงการปิดเสียงได้)'}
CMDs[#CMDs + 1] = {NAME = 'spam [text]', DESC = 'ทำให้คุณสแปมแชท'}
CMDs[#CMDs + 1] = {NAME = 'unspam', DESC = 'ปิดการสแปม'}
CMDs[#CMDs + 1] = {NAME = 'whisper / pm [player] [text]', DESC = 'ทำให้คุณกระซิบข้อความถึงใครบาง sequelize (อาจเลี่ยงการปิดเสียงได้)'}
CMDs[#CMDs + 1] = {NAME = 'pmspam [player] [text]', DESC = 'ทำให้คุณสแปมกระซิบถึงผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'unpmspam [player]', DESC = 'ปิดการสแปมกระซิบ'}
CMDs[#CMDs + 1] = {NAME = 'spamspeed [num]', DESC = 'กำหนดความเร็วในการสแปม (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = 'bubblechat (CLIENT)', DESC = 'เปิดใช้งานแชทแบบฟองสำหรับเครื่องของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'unbubblechat / nobubblechat', DESC = 'ปิดใช้งานคำสั่ง bubblechat'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'esp', DESC = 'ดูผู้เล่นทั้งหมดและสถานะของพวกเขา'}
CMDs[#CMDs + 1] = {NAME = 'noesp / unesp', DESC = 'ลบ ESP'}
CMDs[#CMDs + 1] = {NAME = 'esptransparency [number]', DESC = 'เปลี่ยนความโปร่งใสของคำสั่งที่เกี่ยวข้องกับ ESP'}
CMDs[#CMDs + 1] = {NAME = 'partesp [part name]', DESC = 'ไฮไลต์ชิ้นส่วน'}
CMDs[#CMDs + 1] = {NAME = 'unpartesp / nopartesp [part name]', DESC = 'ลบ partesp'}
CMDs[#CMDs + 1] = {NAME = 'chams', DESC = 'ESP แต่ไม่มีข้อความขวางทาง'}
CMDs[#CMDs + 1] = {NAME = 'nochams / unchams', DESC = 'ลบ chams'}
CMDs[#CMDs + 1] = {NAME = 'locate [player]', DESC = 'ดูผู้เล่นคนเดียวและสถานะของเขา'}
CMDs[#CMDs + 1] = {NAME = 'unlocate / nolocate [player]', DESC = 'ลบ locate'}
CMDs[#CMDs + 1] = {NAME = 'xray', DESC = 'ทำให้ทุกชิ้นส่วนใน workspace โปร่งใส'}
CMDs[#CMDs + 1] = {NAME = 'unxray / noxray', DESC = 'คืนค่าความโปร่งใส'}
CMDs[#CMDs + 1] = {NAME = 'loopxray', DESC = 'ทำให้ทุกชิ้นส่วนใน workspace โปร่งใสแบบวนซ้ำ'}
CMDs[#CMDs + 1] = {NAME = 'unloopunxray', DESC = 'หยุดการวนซ้ำ xray'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'spectate / view [player]', DESC = 'ดูผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [part name]', DESC = 'ดูชิ้นส่วน'}
CMDs[#CMDs + 1] = {NAME = 'unspectate / unview', DESC = 'หยุดการดูผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'freecam / fc', DESC = 'ให้คุณเคลื่อนกล้องได้อย่างอิสระในเกม'}
CMDs[#CMDs + 1] = {NAME = 'freecampos / fcpos [X Y Z]', DESC = 'ย้ายหรือเปิด freecam ในตำแหน่งที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'freecamwaypoint / fcwp [name]', DESC = 'ย้ายหรือเปิด freecam ไปยังจุดหมาย'}
CMDs[#CMDs + 1] = {NAME = 'freecamgoto / fcgoto / fctp [player]', DESC = 'ย้ายหรือเปิด freecam ไปหาผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'unfreecam / unfc', DESC = 'ปิดใช้งาน freecam'}
CMDs[#CMDs + 1] = {NAME = 'freecamspeed / fcspeed [num]', DESC = 'ปรับความเร็ว freecam (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = 'notifyfreecamposition / notifyfcpos', DESC = 'แจ้งเตือนพิกัด freecam ของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'copyfreecamposition / copyfcpos', DESC = 'คัดลอกพิกัด freecam ของคุณไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'gotocamera / gotocam', DESC = 'ย้ายคุณไปยังตำแหน่งของกล้อง'}
CMDs[#CMDs + 1] = {NAME = 'tweengotocam / tgotocam', DESC = 'เคลื่อนคุณไปยังตำแหน่งของกล้องแบบนุ่มนวล'}
CMDs[#CMDs + 1] = {NAME = 'firstp', DESC = 'บังคับกล้องให้เป็นมุมมองบุคคลที่หนึ่ง'}
CMDs[#CMDs + 1] = {NAME = 'thirdp', DESC = 'อนุญาตให้กล้องเป็นมุมมองบุคคลที่สาม'}
CMDs[#CMDs + 1] = {NAME = 'noclipcam / nccam', DESC = 'ให้กล้องผ่านวัตถุเช่นกำแพงได้'}
CMDs[#CMDs + 1] = {NAME = 'maxzoom [num]', DESC = 'ระยะซูมกล้องสูงสุด'}
CMDs[#CMDs + 1] = {NAME = 'minzoom [num]', DESC = 'ระยะซูมกล้องขั้นต่ำ'}
CMDs[#CMDs + 1] = {NAME = 'camdistance [num]', DESC = 'เปลี่ยนระยะห่างของกล้องจากตัวคุณ'}
CMDs[#CMDs + 1] = {NAME = 'fov [num]', DESC = 'ปรับมุมมองภาพ (ค่าเริ่มต้นคือ 70)'}
CMDs[#CMDs + 1] = {NAME = 'fixcam / restorecam', DESC = 'แก้ไขกล้อง'}
CMDs[#CMDs + 1] = {NAME = 'enableshiftlock / enablesl', DESC = 'เปิดใช้งานตัวเลือก Shift Lock'}
CMDs[#CMDs + 1] = {NAME = 'lookat [player]', DESC = 'เลื่อนมุมมองกล้องไปยังผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'btools (CLIENT)', DESC = 'ให้เครื่องมือสร้าง (ไม่ซิงค์กับเซิร์ฟเวอร์)'}
CMDs[#CMDs + 1] = {NAME = 'f3x (CLIENT)', DESC = 'ให้เครื่องมือสร้าง F3X (ไม่ซิงค์กับเซิร์ฟเวอร์)'}
CMDs[#CMDs + 1] = {NAME = 'partname / partpath', DESC = 'ให้คุณคลิกชิ้นส่วนเพื่อดูเส้นทางและชื่อ'}
CMDs[#CMDs + 1] = {NAME = 'delete [instance name] (CLIENT)', DESC = 'ลบชิ้นส่วนที่มีชื่อที่ระบุออกจาก workspace (ไม่ซิงค์กับเซิร์ฟเวอร์)'}
CMDs[#CMDs + 1] = {NAME = 'deleteclass / dc [class name] (CLIENT)', DESC = 'ลบชิ้นส่วนที่มีชื่อคลาสที่ระบุออกจาก workspace (ไม่ซิงค์กับเซิร์ฟเวอร์)'}
CMDs[#CMDs + 1] = {NAME = 'lockworkspace / lockws', DESC = 'ล็อกทั้ง workspace'}
CMDs[#CMDs + 1] = {NAME = 'unlockworkspace / unlockws', DESC = 'ปลดล็อกทั้ง workspace'}
CMDs[#CMDs + 1] = {NAME = 'invisibleparts / invisparts (CLIENT)', DESC = 'แสดงชิ้นส่วนที่มองไม่เห็น'}
CMDs[#CMDs + 1] = {NAME = 'uninvisibleparts / uninvisparts (CLIENT)', DESC = 'ทำให้ชิ้นส่วนที่ได้รับผลจาก invisparts กลับสู่ปกติ'}
CMDs[#CMDs + 1] = {NAME = 'deleteinvisparts / dip (CLIENT)', DESC = 'ลบชิ้นส่วนที่มองไม่เห็น'}
CMDs[#CMDs + 1] = {NAME = 'gotopart [part name]', DESC = 'ย้ายตัวละครของคุณไปยังชิ้นส่วนหรือหลายชิ้นส่วน'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopart / tgotopart [part name]', DESC = 'เคลื่อนตัวละครของคุณไปยังชิ้นส่วนหรือหลายชิ้นส่วนแบบนุ่มนวล'}
CMDs[#CMDs + 1] = {NAME = 'gotopartclass / gpc [class name]', DESC = 'ย้ายตัวละครของคุณไปยังชิ้นส่วนหรือหลายชิ้นส่วนตามชื่อคลาส'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopartclass / tgpc [class name]', DESC = 'เคลื่อนตัวละครของคุณไปยังชิ้นส่วนหรือหลายชิ้นส่วนตามชื่อคลาสแบบนุ่มนวล'}
CMDs[#CMDs + 1] = {NAME = 'gotomodel [part name]', DESC = 'ย้ายตัวละครของคุณไปยังโมเดลหรือหลายโมเดล'}
CMDs[#CMDs + 1] = {NAME = 'tweengotomodel / tgotomodel [part name]', DESC = 'เคลื่อนตัวละครของคุณไปยังโมเดลหรือหลายโมเดลแบบนุ่มนวล'}
CMDs[#CMDs + 1] = {NAME = 'gotopartdelay / gotomodeldelay [num]', DESC = 'ปรับความเร็วในการย้ายไปยังแต่ละชิ้นส่วน (ค่าเริ่มต้นคือ 0.1)'}
CMDs[#CMDs + 1] = {NAME = 'bringpart [part name] (CLIENT)', DESC = 'ย้ายชิ้นส่วนหรือหลายชิ้นส่วนมาหาตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'bringpartclass / bpc [class name] (CLIENT)', DESC = 'ย้ายชิ้นส่วนหรือหลายชิ้นส่วนมาหาตัวละครของคุณตามชื่อคลาส'}
CMDs[#CMDs + 1] = {NAME = 'noclickdetectorlimits / nocdlimits', DESC = 'ตั้งค่า MaxActivationDistance ของ Click Detectors ทั้งหมดเป็น infinity'}
CMDs[#CMDs + 1] = {NAME = 'fireclickdetectors / firecd [name]', DESC = 'ใช้งาน Click Detectors ทั้งหมดในเกมหรือใช้ชื่อที่ระบุ'}
CMDs[#CMDs + 1] = {NAME = 'firetouchinterests / touchinterests [name]', DESC = 'ใช้งาน TouchInterests ทั้งหมดในเกมหรือใช้ชื่อที่ระบุ'}
CMDs[#CMDs + 1] = {NAME = 'noproximitypromptlimits / nopplimits', DESC = 'ตั้งค่า MaxActivationDistance ของ Proximity Prompts ทั้งหมดเป็น infinity'}
CMDs[#CMDs + 1] = {NAME = 'fireproximityprompts / firepp [name]', DESC = 'ใช้งาน Proximity Prompts ทั้งหมดในเกมหรือใช้ชื่อที่ระบุ'}
CMDs[#CMDs + 1] = {NAME = 'instantproximityprompts / instantpp', DESC = 'ปิดการหน่วงเวลาของ Proximity Prompts'}
CMDs[#CMDs + 1] = {NAME = 'uninstantproximityprompts / uninstantpp', DESC = 'ยกเลิกการปิดหน่วงเวลา'}
CMDs[#CMDs + 1] = {NAME = 'tpunanchored / tpua [player]', DESC = 'ย้ายชิ้นส่วนที่ไม่ยึดติดไปหาผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'animsunanchored / freezeua', DESC = 'แช่แข็งชิ้นส่วนที่ไม่ยึดติด'}
CMDs[#CMDs + 1] = {NAME = 'thawunanchored / thawua / unfreezeua', DESC = 'ปลดแช่แข็งชิ้นส่วนที่ไม่ยึดติด'}
CMDs[#CMDs + 1] = {NAME = 'removeterrain / rterrain / noterrain', DESC = 'ลบภูมิประเทศทั้งหมด'}
CMDs[#CMDs + 1] = {NAME = 'clearnilinstances / nonilinstances / cni', DESC = 'ลบอินสแตนซ์ที่เป็น nil'}
CMDs[#CMDs + 1] = {NAME = 'destroyheight / dh [num]', DESC = 'ตั้งค่า FallenPartsDestroyHeight'}
CMDs[#CMDs + 1] = {NAME = 'fakeout', DESC = 'ย้ายไปยังช่องว่างแล้วกลับมา (มีประโยชน์ในการฆ่าคนที่ติดกับคุณ)'}
CMDs[#CMDs + 1] = {NAME = 'antivoid', DESC = 'ป้องกันคุณจากการตกลงไปในช่องว่างโดยการดีดคุณขึ้น'}
CMDs[#CMDs + 1] = {NAME = 'unantivoid / noantivoid', DESC = 'ปิดใช้งาน antivoid'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (CLIENT)', DESC = 'ทำให้แผนที่สว่างขึ้น / มองเห็นได้ชัดเจน'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (CLIENT)', DESC = 'ทำให้แผนที่สว่างขึ้น / มองเห็นได้ชัดเจนแบบวนซ้ำ'}
CMDs[#CMDs + 1] = {NAME = 'unloopfullbright / unloopfb', DESC = 'หยุดการวนซ้ำ fullbright'}
CMDs[#CMDs + 1] = {NAME = 'ambient [num] [num] [num] (CLIENT)', DESC = 'เปลี่ยนแสงแวดล้อม'}
CMDs[#CMDs + 1] = {NAME = 'day (CLIENT)', DESC = 'เปลี่ยนเวลาเป็นกลางวันสำหรับเครื่องของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'night (CLIENT)', DESC = 'เปลี่ยนเวลาเป็นกลางคืนสำหรับเครื่องของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'nofog (CLIENT)', DESC = 'ลบหมอก'}
CMDs[#CMDs + 1] = {NAME = 'brightness [num] (CLIENT)', DESC = 'เปลี่ยนคุณสมบัติความสว่างของแสง'}
CMDs[#CMDs + 1] = {NAME = 'globalshadows / gshadows (CLIENT)', DESC = 'เปิดใช้งานเงาทั่วไป'}
CMDs[#CMDs + 1] = {NAME = 'noglobalshadows / nogshadows (CLIENT)', DESC = 'ปิดใช้งานเงาทั่วไป'}
CMDs[#CMDs + 1] = {NAME = 'restorelighting / rlighting', DESC = 'คืนค่าคุณสมบัติแสงให้เป็นปกติ'}
CMDs[#CMDs + 1] = {NAME = 'light [radius] [brightness] (CLIENT)', DESC = 'ให้แสงแบบไดนามิกแก่ตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'nolight / unlight', DESC = 'ลบแสงแบบไดนามิกจากตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'inspect / examine [player]', DESC = 'เปิดเมนูตรวจสอบสำหรับผู้เล่นบางคน'}
CMDs[#CMDs + 1] = {NAME = 'age [player]', DESC = 'บอกอายุของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'chatage [player]', DESC = 'แชทอายุของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'joindate / jd [player]', DESC = 'บอกวันที่ผู้เล่นเข้าร่วม Roblox'}
CMDs[#CMDs + 1] = {NAME = 'chatjoindate / cjd [player]', DESC = 'แชทวันที่ผู้เล่นเข้าร่วม Roblox'}
CMDs[#CMDs + 1] = {NAME = 'copyname / copyuser [player]', DESC = 'คัดลอกชื่อผู้ใช้เต็มของผู้เล่นไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'userid / id [player]', DESC = 'แจ้งเตือน ID ผู้ใช้ของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'copyuserid / copyid [player]', DESC = 'คัดลอก ID ผู้ใช้ของผู้เล่นไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'appearanceid / aid [player]', DESC = 'แจ้งเตือน ID รูปลักษณ์ของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'copyappearanceid / caid [player]', DESC = 'คัดลอก ID รูปลักษณ์ของผู้เล่นไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'bang [player] [speed]', DESC = 'owo'}
CMDs[#CMDs + 1] = {NAME = 'unbang', DESC = 'uwu'}
CMDs[#CMDs + 1] = {NAME = 'carpet [player]', DESC = 'เป็นพรมของใครบางคน'}
CMDs[#CMDs + 1] = {NAME = 'uncarpet', DESC = 'ยกเลิก carpet'}
CMDs[#CMDs + 1] = {NAME = 'friend [player]', DESC = 'ส่งคำขอเป็นเพื่อนถึงผู้เล่นบางคน'}
CMDs[#CMDs + 1] = {NAME = 'unfriend [player]', DESC = 'เลิกเป็นเพื่อนกับผู้เล่นบางคน'}
CMDs[#CMDs + 1] = {NAME = 'headsit [player]', DESC = 'นั่งบนหัวของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'walkto / follow [player]', DESC = 'ตามผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalkto / pathfindfollow [player]', DESC = 'ตามผู้เล่นโดยใช้การค้นหาเส้นทาง'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalktowaypoint / pathfindwalktowp [waypoint]', DESC = 'เดินไปยังจุดหมายโดยใช้การค้นหาเส้นทาง'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto / unfollow', DESC = 'หยุดตามผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'orbit [player] [speed] [distance]', DESC = 'ทำให้ตัวละครของคุณโคจรรอบผู้เล่นด้วยความเร็วและระยะทางที่เลือกได้'}
CMDs[#CMDs + 1] = {NAME = 'unorbit', DESC = 'ปิดใช้งาน orbit'}
CMDs[#CMDs + 1] = {NAME = 'stareat / stare [player]', DESC = 'จ้องมอง / มองไปที่ผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'unstareat / unstare [player]', DESC = 'ปิดใช้งาน stareat'}
CMDs[#CMDs + 1] = {NAME = 'rolewatch [group id] [role name]', DESC = 'แจ้งเตือนหากมีคนจากกลุ่มที่เฝ้าดูเข้าร่วมเซิร์ฟเวอร์'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchstop / unrolewatch', DESC = 'ปิดใช้งาน Rolewatch'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchleave', DESC = 'สลับว่าคุณควรออกจากเกมหรือไม่หากมีคนจากกลุ่มที่เฝ้าดูเข้าร่วมเซิร์ฟเวอร์'}
CMDs[#CMDs + 1] = {NAME = 'staffwatch', DESC = 'แจ้งเตือนหากมีพนักงานของเกมเข้าร่วมเซิร์ฟเวอร์'}
CMDs[#CMDs + 1] = {NAME = 'unstaffwatch', DESC = 'ปิดใช้งาน Staffwatch'}
CMDs[#CMDs + 1] = {NAME = 'attach [player] (TOOL)', DESC = 'ติดตัวคุณกับผู้เล่น (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'kill [player] (TOOL)', DESC = 'ฆ่าผู้เล่น (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'fastkill [player] (TOOL)', DESC = 'ฆ่าผู้เล่น (น่าเชื่อถือน้อยกว่า) (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'handlekill / hkill [player] (TOOL)', DESC = 'ฆ่าผู้เล่นโดยใช้ความเสียหายจากเครื่องมือ (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'bring [player] (TOOL)', DESC = 'นำผู้เล่นมาหาคุณ (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'fastbring [player] (TOOL)', DESC = 'นำผู้เล่นมาหาคุณ (น่าเชื่อถือน้อยกว่า) (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'teleport / tp [player] [player] (TOOL)', DESC = 'ย้ายผู้เล่นไปหาผู้เล่นอีกคน (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'fastteleport / fasttp [player] [player] (TOOL)', DESC = 'ย้ายผู้เล่นไปหาผู้เล่นอีกคน (น่าเชื่อถือน้อยกว่า) (คุณต้องมีเครื่องมือ)'}
CMDs[#CMDs + 1] = {NAME = 'fling', DESC = 'ดีดทุกคนที่คุณสัมผัส'}
CMDs[#CMDs + 1] = {NAME = 'unfling', DESC = 'ปิดใช้งานคำสั่ง fling'}
CMDs[#CMDs + 1] = {NAME = 'flyfling [speed]', DESC = 'เหมือนคำสั่ง invisfling แต่ไม่มองไม่เห็น'}
CMDs[#CMDs + 1] = {NAME = 'unflyfling', DESC = 'ปิดใช้งานคำสั่ง flyfling'}
CMDs[#CMDs + 1] = {NAME = 'walkfling', DESC = 'เหมือน fling แต่ไม่หมุน'}
CMDs[#CMDs + 1] = {NAME = 'unwalkfling / nowalkfling', DESC = 'ปิดใช้งาน walkfling'}
CMDs[#CMDs + 1] = {NAME = 'invisfling', DESC = 'เปิดใช้งานการดีดแบบมองไม่เห็น'}
CMDs[#CMDs + 1] = {NAME = 'antifling', DESC = 'ปิดการชนของผู้เล่นเพื่อป้องกันคุณจากการถูกดีด'}
CMDs[#CMDs + 1] = {NAME = 'unantifling', DESC = 'ปิดใช้งาน antifling'}
CMDs[#CMDs + 1] = {NAME = 'loopoof', DESC = 'วนซ้ำเสียงตัวละครของทุกคน (ทุกคนได้ยิน)'}
CMDs[#CMDs + 1] = {NAME = 'unloopoof', DESC = 'หยุดความโกลาหลของ oof'}
CMDs[#CMDs + 1] = {NAME = 'muteboombox [player]', DESC = 'ปิดเสียงบูมบ็อกซ์ของบางคน'}
CMDs[#CMDs + 1] = {NAME = 'unmuteboombox [player]', DESC = 'เปิดเสียงบูมบ็อกซ์ของบางคน'}
CMDs[#CMDs + 1] = {NAME = 'hitbox [player] [size] [transparency]', DESC = 'ขยาย hitbox ของ HumanoidRootPart ของผู้เล่น (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = 'headsize [player] [size]', DESC = 'ขยายขนาดหัวของผู้เล่น (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = 'รีเซ็ตตัวละครของคุณตามปกติ'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = 'เกิดใหม่'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = 'เกิดใหม่และนำคุณกลับมาที่ตำแหน่งเดิม'}
CMDs[#CMDs + 1] = {NAME = 'god', DESC = 'ทำให้ตัวละครของคุณตายยากในเกมส่วนใหญ่'}
CMDs[#CMDs + 1] = {NAME = 'invisible / invis', DESC = 'ทำให้คุณมองไม่เห็นสำหรับผู้เล่นคนอื่น'}
CMDs[#CMDs + 1] = {NAME = 'visible / vis', DESC = 'ทำให้คุณมองเห็นได้สำหรับผู้เล่นคนอื่น'}
CMDs[#CMDs + 1] = {NAME = 'toolinvisible / toolinvis / tinvis', DESC = 'ทำให้คุณมองไม่เห็นสำหรับผู้เล่นคนอื่นและสามารถใช้เครื่องมือได้'}
CMDs[#CMDs + 1] = {NAME = 'speed / ws / walkspeed [num]', DESC = 'เปลี่ยนความเร็วในการเดิน'}
CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [num]', DESC = 'ปลอมความเร็วในการเดินของคุณในเครื่อง'}
CMDs[#CMDs + 1] = {NAME = 'loopspeed / loopws [num]', DESC = 'วนซ้ำความเร็วในการเดิน'}
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / unloopws', DESC = 'ปิด loopspeed'}
CMDs[#CMDs + 1] = {NAME = 'hipheight / hheight [num]', DESC = 'ปรับความสูงสะโพก'}
CMDs[#CMDs + 1] = {NAME = 'jumppower / jpower / jp [num]', DESC = 'เปลี่ยนความสูงในการกระโดดของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [num]', DESC = 'ปลอมความสูงในการกระโดดของคุณในเครื่อง'}
CMDs[#CMDs + 1] = {NAME = 'loopjumppower / loopjp [num]', DESC = 'วนซ้ำความสูงในการกระโดด'}
CMDs[#CMDs + 1] = {NAME = 'unloopjumppower / unloopjp', DESC = 'ปิด loopjumppower'}
CMDs[#CMDs + 1] = {NAME = 'maxslopeangle / msa [num]', DESC = 'ปรับ MaxSlopeAngle'}
CMDs[#CMDs + 1] = {NAME = 'gravity / grav [num] (CLIENT)', DESC = 'เปลี่ยนแรงโน้มถ่วงของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'sit', DESC = 'ทำให้ตัวละครของคุณนั่ง'}
CMDs[#CMDs + 1] = {NAME = 'lay / laydown', DESC = 'ทำให้ตัวละครของคุณนอนลง'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk', DESC = 'ทำให้ตัวละครของคุณนั่งแต่ยังเดินได้'}
CMDs[#CMDs + 1] = {NAME = 'nosit', DESC = 'ป้องกันตัวละครของคุณจากการนั่ง'}
CMDs[#CMDs + 1] = {NAME = 'unnosit', DESC = 'ปิดใช้งาน nosit'}
CMDs[#CMDs + 1] = {NAME = 'jump', DESC = 'ทำให้ตัวละครของคุณกระโดด'}
CMDs[#CMDs + 1] = {NAME = 'infinitejump / infjump', DESC = 'ให้คุณกระโดดได้ก่อนถึงพื้น'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfjump', DESC = 'ปิดใช้งาน infjump'}
CMDs[#CMDs + 1] = {NAME = 'flyjump', DESC = 'ให้คุณกด Space ค้างเพื่อบินขึ้น'}
CMDs[#CMDs + 1] = {NAME = 'unflyjump', DESC = 'ปิดใช้งาน flyjump'}
CMDs[#CMDs + 1] = {NAME = 'autojump / ajump', DESC = 'กระโดดอัตโนมัติเมื่อคุณวิ่งชนวัตถุ'}
CMDs[#CMDs + 1] = {NAME = 'unautojump / unajump', DESC = 'ปิดใช้งาน autojump'}
CMDs[#CMDs + 1] = {NAME = 'edgejump / ejump', DESC = 'กระโดดอัตโนมัติเมื่อคุณถึงขอบของวัตถุ'}
CMDs[#CMDs + 1] = {NAME = 'unedgejump / unejump', DESC = 'ปิดใช้งาน edgejump'}
CMDs[#CMDs + 1] = {NAME = 'platformstand / stun', DESC = 'เปิดใช้งาน PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'unplatformstand / unstun', DESC = 'ปิดใช้งาน PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'norotate / noautorotate', DESC = 'ปิดใช้งาน AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'unnorotate / autorotate', DESC = 'เปิดใช้งาน AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'enablestate [StateType]', DESC = 'เปิดใช้งานประเภทสถานะของ humanoid'}
CMDs[#CMDs + 1] = {NAME = 'disablestate [StateType]', DESC = 'ปิดใช้งานประเภทสถานะของ humanoid'}
CMDs[#CMDs + 1] = {NAME = 'team [team name] (CLIENT)', DESC = 'เปลี่ยนทีมของคุณ บางครั้งหลอกสคริปต์ในเครื่องได้'}
CMDs[#CMDs + 1] = {NAME = 'nobillboardgui / nobgui / noname', DESC = 'ลบ Billboard และ Surface GUI จากตัวละครของคุณ (เช่น GUI ชื่อที่ร้านกาแฟ)'}
CMDs[#CMDs + 1] = {NAME = 'loopnobgui / loopnoname', DESC = 'วนซ้ำการลบ Billboard และ Surface GUI จากตัวละครของคุณ (เช่น GUI ชื่อที่ร้านกาแฟ)'}
CMDs[#CMDs + 1] = {NAME = 'unloopnobgui / unloopnoname', DESC = 'ปิดใช้งาน loopnobgui'}
CMDs[#CMDs + 1] = {NAME = 'noarms', DESC = 'ลบแขนของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'nolegs', DESC = 'ลบขาของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'nolimbs', DESC = 'ลบแขนขาของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'naked (CLIENT)', DESC = 'ลบเสื้อผ้าของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'noface / removeface', DESC = 'ลบหน้าของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'blockhead', DESC = 'เปลี่ยนหัวของคุณเป็นบล็อก'}
CMDs[#CMDs + 1] = {NAME = 'blockhats', DESC = 'เปลี่ยนหมวกของคุณเป็นบล็อก'}
CMDs[#CMDs + 1] = {NAME = 'blocktool', DESC = 'เปลี่ยนเครื่องมือที่เลือกอยู่เป็นบล็อก'}
CMDs[#CMDs + 1] = {NAME = 'creeper', DESC = 'ทำให้คุณดูเหมือนครีปเปอร์'}
CMDs[#CMDs + 1] = {NAME = 'drophats', DESC = 'ทิ้งหมวกของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats', DESC = 'ลบหมวกของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'hatspin / spinhats', DESC = 'หมุนเครื่องประดับของตัวละครคุณ'}
CMDs[#CMDs + 1] = {NAME = 'unhatspin / unspinhats', DESC = 'ยกเลิก spinhats'}
CMDs[#CMDs + 1] = {NAME = 'clearhats / cleanhats', DESC = 'ล้างหมวกใน workspace'}
CMDs[#CMDs + 1] = {NAME = 'chardelete / cd [instance name]', DESC = 'ลบชิ้นส่วนที่มีชื่อที่ระบุออกจากตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'chardeleteclass / cdc [class name]', DESC = 'ลบชิ้นส่วนที่มีชื่อคลาสที่ระบุออกจากตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'deletevelocity / dv / removeforces', DESC = 'ลบอินสแตนซ์ความเร็ว / แรงในตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'weaken [num]', DESC = 'ทำให้ตัวละครของคุณมีความหนาแน่นน้อยลง'}
CMDs[#CMDs + 1] = {NAME = 'unweaken', DESC = 'ตั้งค่า CustomPhysicalProperties ของตัวละครคุณเป็นค่าเริ่มต้น'}
CMDs[#CMDs + 1] = {NAME = 'strengthen [num]', DESC = 'ทำให้ตัวละครของคุณมีความหนาแน่นมากขึ้น (CustomPhysicalProperties)'}
CMDs[#CMDs + 1] = {NAME = 'unstrengthen', DESC = 'ตั้งค่า CustomPhysicalProperties ของตัวละครคุณเป็นค่าเริ่มต้น'}
CMDs[#CMDs + 1] = {NAME = 'breakvelocity', DESC = 'ตั้งค่าความเร็วของตัวละครคุณเป็น 0'}
CMDs[#CMDs + 1] = {NAME = 'spin [speed]', DESC = 'หมุนตัวละครของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'unspin', DESC = 'ปิดใช้งาน spin'}
CMDs[#CMDs + 1] = {NAME = 'split', DESC = 'แบ่งตัวละครของคุณออกเป็นครึ่ง'}
CMDs[#CMDs + 1] = {NAME = 'nilchar', DESC = 'ตั้งค่าพ่อแม่ของตัวละครคุณเป็น nil'}
CMDs[#CMDs + 1] = {NAME = 'unnilchar / nonilchar', DESC = 'ตั้งค่าพ่อแม่ของตัวละครคุณเป็น workspace'}
CMDs[#CMDs + 1] = {NAME = 'noroot / removeroot / rroot', DESC = 'ลบ HumanoidRootPart ของตัวละครคุณ'}
CMDs[#CMDs + 1] = {NAME = 'replaceroot', DESC = 'แทนที่ HumanoidRootPart ของตัวละครคุณ'}
CMDs[#CMDs + 1] = {NAME = 'clearcharappearance / clearchar / clrchar', DESC = 'ลบเครื่องประดับ เสื้อ กางเกง CharacterMesh และ BodyColors ทั้งหมด'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'animation / anim [ID] [speed]', DESC = 'ทำให้ตัวละครของคุณแสดงแอนิเมชัน (ต้องเป็นของ Roblox เพื่อซิงค์)'}
CMDs[#CMDs + 1] = {NAME = 'dance', DESC = 'ทำให้คุณเต้น'}
CMDs[#CMDs + 1] = {NAME = 'undance', DESC = 'หยุดแอนิเมชันเต้น'}
CMDs[#CMDs + 1] = {NAME = 'spasm', DESC = 'ทำให้คุณดูบ้าคลั่ง'}
CMDs[#CMDs + 1] = {NAME = 'unspasm', DESC = 'หยุด spasm'}
CMDs[#CMDs + 1] = {NAME = 'headthrow', DESC = 'ทำให้คุณโยนหัวของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'noanim', DESC = 'ปิดใช้งานแอนิเมชันของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'reanim', DESC = 'คืนค่าแอนิเมชันของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'animspeed [num]', DESC = 'เปลี่ยนความเร็วของแอนิเมชันปัจจุบันของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'copyanimation / copyanim / copyemote [player]', DESC = 'คัดลอกแอนิเมชันของคนอื่น'}
CMDs[#CMDs + 1] = {NAME = 'copyanimationid / copyanimid / copyemoteid [player]', DESC = 'คัดลอก ID แอนิเมชันของคุณหรือของคนอื่นไปยังคลิปบอร์ด'}
CMDs[#CMDs + 1] = {NAME = 'loopanimation / loopanim', DESC = 'วนซ้ำแอนิเมชันปัจจุบันของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'stopanimations / stopanims', DESC = 'หยุดแอนิเมชันที่กำลังทำงาน'}
CMDs[#CMDs + 1] = {NAME = 'refreshanimations / refreshanims', DESC = 'รีเฟรชแอนิเมชัน'}
CMDs[#CMDs + 1] = {NAME = 'allowcustomanim / allowcustomanimations', DESC = 'ให้คุณใช้ชุดแอนิเมชันแบบกำหนดเองแทน'}
CMDs[#CMDs + 1] = {NAME = 'unallowcustomanim / unallowcustomanimations', DESC = 'ไม่อนุญาตให้คุณใช้ชุดแอนิเมชันแบบกำหนดเองแทน'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'autoclick [click delay] [release delay]', DESC = 'คลิกเมาส์อัตโนมัติด้วยการหน่วงเวลาที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'unautoclick / noautoclick', DESC = 'ปิด autoclick'}
CMDs[#CMDs + 1] = {NAME = 'autokeypress [key] [down delay] [up delay]', DESC = 'กดปุ่มอัตโนมัติด้วยการหน่วงเวลาที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'unautokeypress', DESC = 'หยุด autokeypress'}
CMDs[#CMDs + 1] = {NAME = 'hovername', DESC = 'แสดงชื่อผู้ใช้ของผู้เล่นเมื่อเมาส์เลื่อนไปเหนือพวกเขา'}
CMDs[#CMDs + 1] = {NAME = 'unhovername / nohovername', DESC = 'ปิด hovername'}
CMDs[#CMDs + 1] = {NAME = 'mousesensitivity / ms [0-10]', DESC = 'ตั้งค่าความไวเมาส์ (มีผลต่อมุมมองบุคคลที่หนึ่งและการลากคลิกขวา) (ค่าเริ่มต้นคือ 1)'}
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = 'ไปที่การตั้งค่า > Keybinds > Add เพื่อใช้ clicktp'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = 'ไปที่การตั้งค่า > Keybinds > Add เพื่อใช้ click tp'}
CMDs[#CMDs + 1] = {NAME = 'mouseteleport / mousetp', DESC = 'ย้ายตัวละครของคุณไปยังตำแหน่งเมาส์ แนะนำให้ตั้งเป็นปุ่มลัด'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'tools', DESC = 'คัดลอกเครื่องมือจาก ReplicatedStorage และ Lighting'}
CMDs[#CMDs + 1] = {NAME = 'notools / removetools / deletetools', DESC = 'ลบเครื่องมือออกจากตัวละครและกระเป๋า'}
CMDs[#CMDs + 1] = {NAME = 'deleteselectedtool / dst', DESC = 'ลบเครื่องมือที่เลือกอยู่ในขณะนี้'}
CMDs[#CMDs + 1] = {NAME = 'grabtools', DESC = 'รับเครื่องมือที่หล่นอัตโนมัติ'}
CMDs[#CMDs + 1] = {NAME = 'ungrabtools / nograbtools', DESC = 'ปิดใช้งาน grabtools'}
CMDs[#CMDs + 1] = {NAME = 'copytools [player] (CLIENT)', DESC = 'คัดลอกเครื่องมือของผู้เล่น'}
CMDs[#CMDs + 1] = {NAME = 'dupetools / clonetools [num]', DESC = 'ทำซ้ำเครื่องมือในกระเป๋าของคุณตามจำนวนที่กำหนด'}
CMDs[#CMDs + 1] = {NAME = 'givetool / givetools', DESC = 'ให้เครื่องมือทั้งหมดที่คุณถืออยู่แก่ [ผู้เล่น] โดยใช้วิธี attach'}
CMDs[#CMDs + 1] = {NAME = 'droptools', DESC = 'ทิ้งเครื่องมือของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'droppabletools', DESC = 'ทำให้เครื่องมือของคุณสามารถทิ้งได้'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = 'สวมเครื่องมือทุกชิ้นในกระเป๋าของคุณพร้อมกัน'}
CMDs[#CMDs + 1] = {NAME = 'unequiptools', DESC = 'ถอนการสวมเครื่องมือทุกชิ้นที่คุณถืออยู่พร้อมกัน'}
CMDs[#CMDs + 1] = {NAME = 'removespecifictool [name]', DESC = 'ลบเครื่องมือที่ระบุออกจากกระเป๋าของคุณอัตโนมัติ'}
CMDs[#CMDs + 1] = {NAME = 'unremovespecifictool [name]', DESC = 'หยุดการลบเครื่องมือที่ระบุออกจากกระเป๋าของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'clearremovespecifictool', DESC = 'หยุดการลบเครื่องมือที่ระบุทั้งหมดออกจากกระเป๋าของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'reach [num]', DESC = 'เพิ่ม hitbox ของเครื่องมือที่ถืออยู่'}
CMDs[#CMDs + 1] = {NAME = 'boxreach [num]', DESC = 'เพิ่ม hitbox ของเครื่องมือที่ถืออยู่ในรูปทรงกล่อง'}
CMDs[#CMDs + 1] = {NAME = 'unreach / noreach', DESC = 'ปิด reach'}
CMDs[#CMDs + 1] = {NAME = 'grippos [X Y Z]', DESC = 'เปลี่ยนตำแหน่งการจับของเครื่องมือปัจจุบัน'}
CMDs[#CMDs + 1] = {NAME = 'usetools [ammount] [delay]', DESC = 'ใช้งานเครื่องมือทั้งหมดในกระเป๋าของคุณพร้อมกัน'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addalias [cmd] [alias]', DESC = 'เพิ่มชื่อแทนให้กับคำสั่ง'}
CMDs[#CMDs + 1] = {NAME = 'removealias [alias]', DESC = 'ลบชื่อแทนที่กำหนดเอง'}
CMDs[#CMDs + 1] = {NAME = 'clraliases', DESC = 'ลบชื่อแทนที่กำหนดเองทั้งหมด'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addplugin / plugin [name]', DESC = 'เพิ่มปลั๊กอินผ่านคำสั่ง'}
CMDs[#CMDs + 1] = {NAME = 'removeplugin / deleteplugin [name]', DESC = 'ลบปลั๊กอินผ่านคำสั่ง'}
CMDs[#CMDs + 1] = {NAME = 'reloadplugin [name]', DESC = 'โหลดปลั๊กอินใหม่'}
CMDs[#CMDs + 1] = {NAME = 'addallplugins / loadallplugins', DESC = 'เพิ่มปลั๊กอินทั้งหมดที่มีจากโฟลเดอร์ workspace'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'breakloops / break (cmd loops)', DESC = 'หยุดการวนซ้ำคำสั่งใดๆ (;100^1^cmd)'}
CMDs[#CMDs + 1] = {NAME = 'removecmd / deletecmd', DESC = 'ลบคำสั่งจนกว่าผู้ดูแลจะโหลดใหม่'}
CMDs[#CMDs + 1] = {NAME = 'tpwalk / teleportwalk [num]', DESC = 'ย้ายคุณไปตามทิศทางการเคลื่อนที่'}
CMDs[#CMDs + 1] = {NAME = 'untpwalk / unteleportwalk', DESC = 'ยกเลิก tpwalk / teleportwalk'}
CMDs[#CMDs + 1] = {NAME = 'notifyping / ping', DESC = 'แจ้งเตือน ping ของคุณ'}
CMDs[#CMDs + 1] = {NAME = 'trip', DESC = 'ทำให้ตัวละครของคุณล้มลง'}
CMDs[#CMDs + 1] = {NAME = 'norender', DESC = 'ปิดการเรนเดอร์ 3D เพื่อลดการใช้งาน CPU ของเครื่อง'}
CMDs[#CMDs + 1] = {NAME = 'render', DESC = 'เปิดใช้งานการเรนเดอร์ 3D'}
CMDs[#CMDs + 1] = {NAME = 'use2022materials / 2022materials', DESC = 'เปิดใช้งานพื้นผิววัสดุปี 2022'}
CMDs[#CMDs + 1] = {NAME = 'unuse2022materials / un2022materials', DESC = 'ปิดใช้งานพื้นผิววัสดุปี 2022'}
CMDs[#CMDs + 1] = {NAME = 'promptr6', DESC = 'แจ้งให้เกมเปลี่ยนประเภทตัวละครของคุณเป็น R6'}
CMDs[#CMDs + 1] = {NAME = 'promptr15', DESC = 'แจ้งให้เกมเปลี่ยนประเภทตัวละครของคุณเป็น R15'}
CMDs[#CMDs + 1] = {NAME = 'wallwalk / walkonwalls', DESC = 'เดินบนกำแพง'}
CMDs[#CMDs + 1] = {NAME = 'removeads / adblock', DESC = 'ลบป้ายโฆษณาอัตโนมัติ'}
CMDs[#CMDs + 1] = {NAME = 'scare / spook [player]', DESC = 'ย้ายไปหน้าผู้เล่นเป็นเวลาครึ่งวินาที'}
CMDs[#CMDs + 1] = {NAME = 'alignmentkeys', DESC = 'เปิดใช้งานปุ่มจัดตำแหน่งซ้ายและขวา (ลูกน้ำและจุด)'}
CMDs[#CMDs + 1] = {NAME = 'unalignmentkeys / noalignmentkeys', DESC = 'ปิดใช้งานปุ่มจัดตำแหน่ง'}
CMDs[#CMDs + 1] = {NAME = 'ctrllock', DESC = 'ผูก Shiftlock กับ LeftControl'}
CMDs[#CMDs + 1] = {NAME = 'unctrllock', DESC = 'ผูก Shiftlock กลับไปที่ LeftShift'}
CMDs[#CMDs + 1] = {NAME = 'listento [player]', DESC = 'ฟังบริเวณรอบตัวผู้เล่น สามารถดักฟังด้วย VC ได้ด้วย'}
CMDs[#CMDs + 1] = {NAME = 'unlistento', DESC = 'ปิดใช้งาน listento'}
CMDs[#CMDs + 1] = {NAME = 'jerk', DESC = 'ทำให้คุณเคลื่อนไหวแปลกๆ'}
CMDs[#CMDs + 1] = {NAME = 'unsuspendvc', DESC = 'ปลดการระงับคุณจากแชทด้วยเสียง'}
wait()
